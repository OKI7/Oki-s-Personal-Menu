Locales['en'] = {
	...
	-- Menu Notification
	['missing_rights'] = '~r~You do not have the ~r~rights~w~',
	['no_vehicle'] = '~r~You are not in a vehicle',
	['players_nearby'] = '~b~No players nearby',
	['amount_invalid'] = '~b~Invalid amount',
	...
	['gave_ammo'] = 'You have given x %s ammo  ',
	...
	-- Main Menu
	['mainmenu_subtitle'] = '~y~Your Bag of Tricks',
	...
	-- Menu Voice Level
	['voice_whisper'] = '~g~Whisper',
	['voice_normal'] = '~y~Normal',
	['voice_cry'] = '~b~Shout',

        -- Inventory Menu
	['inventory_title'] = 'Items',
	['inventory_actions_title'] = '~y~Items',
	['inventory_use_button'] = '~r~Use',
	['inventory_give_button'] = '~b~Give',
	['inventory_drop_button'] = 'Discard',

	-- Loadout Menu
	['loadout_title'] = 'Weapons',
	['loadout_actions_title'] = 'Weapons',
	['loadout_give_button'] = '~y~Give',
	['loadout_givemun_button'] = '~b~Give ammo',
	['loadout_drop_button'] = '~r~Throw Weapon',

	-- Wallet Menu
	['wallet_title'] = '~y~License',
	['wallet_option_give'] = 'Give',
	['wallet_job_button'] = '~p~%s - %s',
	['wallet_job2_button'] = 'Organization:%s -',
	['wallet_money_button'] = '~g~Cash: ~g~$%s',
	['wallet_blackmoney_button'] = '~r~Dirty : ~r~$%s',
	['wallet_show_idcard_button'] = '~g~Hand ID',
	['wallet_check_idcard_button'] = '~b~Look your ID card',
	['wallet_show_driver_button'] = '~y~Give driving license',
	['wallet_check_driver_button'] = '~b~Look your driving license',
	['wallet_show_firearms_button'] = '~y~Give gun license',
	['wallet_check_firearms_button'] = '~b~Look your gun license',
