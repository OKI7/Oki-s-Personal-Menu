...
function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
	...
	Menu.Index = 1
	Menu.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = TextureName or "interaction_bgd", Color = { R = 240, G = 25, B = 25, A = A } }
	Menu.Rectangle = nil
...
function RageUI.Menus:SetRectangleBanner(R, G, B, A)
	self.Rectangle = { R = tonumber(R) or 265, G = tonumber(G) or 255, B = tonumber(B) or 255, A = tonumber(A) or 255 }
	self.Sprite = nil
end
