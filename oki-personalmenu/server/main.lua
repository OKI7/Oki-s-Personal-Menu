...
print("Inventory developed by Crack")
...
RegisterNetEvent("menu:requestShowsId", function()
    ...
    MySQL.query('SELECT * FROM users WHERE identifier = ?', {playerSelected.identifier}, function(result)
        if result[1] then
            TriggerClientEvent("menu:sendIdentityShows", playerSelected.source, {
